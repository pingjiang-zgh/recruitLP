    ...
    <div class="register-container">
        ...
        <div class="register-main">
            ...
            <div class="register-main-type">
                <div class="register-main-type-item" :class="{'active': typeIndex === 0}" @click="typeIndex = 0">我要找工作</div>
                <div class="register-main-type-item" :class="{'active': typeIndex === 1}" @click="typeIndex = 1">我要招聘</div>
            </div>
